...
| TASK-039 | UX/UI enhancement track — full pass (craft + workflow) | Frontend lane | in progress — wave 1 (frontend-only fixes) as PR on `task/39-ux-wave1`; John's call 2026-08-31: the first release DMG ships with the enhanced UI, so release packaging waits for this track; audit + plan in `docs/ux-enhancement-proposal.md` |
