    ...
    fn style_store() -> (TempDir, Store) {
        ...
        for index in 0..6 {
            shots.push(Shot {
                ...
                owner_id: DEFAULT_OWNER_ID.to_owned(),
                idx: index,
                start_s: f64::from(index),
                end_s: f64::from(index) + 1.0,
                rep_frame_s: f64::from(index) + 0.4,
                thumb_rel: None,
                scene_score: None,
            });
            shots.push(Shot {
                ...
                owner_id: DEFAULT_OWNER_ID.to_owned(),
                idx: index + 6,
                start_s: f64::from(index) + 6.0,
                end_s: f64::from(index) + 7.0,
                rep_frame_s: f64::from(index) + 6.4,
                thumb_rel: None,
                scene_score: None,
            });
        }
